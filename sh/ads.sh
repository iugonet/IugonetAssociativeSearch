...
../rb/getAdsPaperListOnGoogleSpreadSheet.rb -o /tmp/list.txt
...
if [ -a 'list.txt' ]; then
    cat /tmp/list.txt | awk '{print "curl -o /tmp/index.html -O ",$0,"; ../rb/adsMetadata2itb.rb /tmp/index.html >> ../itb/ads.itb"}' >> /tmp/createItb.sh
